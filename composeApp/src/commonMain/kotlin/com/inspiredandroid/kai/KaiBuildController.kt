...
interface KaiBuildController {
    ...
    /** Scroll up/down in terminal scrollback history. */
    fun scrollTerminalHistory(delta: Int)

    /** Return view to live terminal bottom. */
...
class NoOpKaiBuildController : KaiBuildController {
    ...
    override fun scrollTerminalHistory(delta: Int) {}
    override fun scrollTerminalToBottom() {}
}
