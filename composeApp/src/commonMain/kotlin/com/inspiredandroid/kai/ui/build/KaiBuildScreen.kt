...
import com.inspiredandroid.kai.ui.build.preview.BuildPreviewContent
...
data class KaiBuildActions(
    ...
    val scrollHistory: (delta: Int) -> Unit = {},
...
fun KaiBuildScreen(
    ...
    val actions = remember(viewModel) {
        KaiBuildActions(
            ...
            scrollHistory = viewModel::scrollHistory,
...
internal fun KaiBuildScreenContent(
    ...
    var previewOpen by rememberSaveable(project) { mutableStateOf(false) }
            ...
            if (project != null) {
                ...
                when {
                    ...
                    previewOpen -> {
                        BuildPreviewContent(
                            project = project,
                            onSendCommand = actions.submitLine,
                            modifier = Modifier.fillMaxSize(),
                        )
                    }
                    ...
                    session != null -> BuildTerminalContent(
                        ...
                        onScrollHistory = actions.scrollHistory,
