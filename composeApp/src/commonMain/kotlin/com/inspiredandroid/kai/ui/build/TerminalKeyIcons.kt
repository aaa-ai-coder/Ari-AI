...
internal val TerminalKeyboard: ImageVector by lazy {
    ImageVector.Builder(
        ...
        path(fill = SolidColor(Color.White)) {
            moveTo(6f, 9f); lineTo(7.5f, 9f); lineTo(7.5f, 10.5f); lineTo(6f, 10.5f); close()
            moveTo(9f, 9f); lineTo(10.5f, 9f); lineTo(10.5f, 10.5f); lineTo(9f, 10.5f); close()
            moveTo(12f, 9f); lineTo(13.5f, 9f); lineTo(13.5f, 10.5f); lineTo(12f, 10.5f); close()
            moveTo(15f, 9f); lineTo(16.5f, 9f); lineTo(16.5f, 10.5f); lineTo(15f, 10.5f); close()
            moveTo(18f, 9f); lineTo(19.5f, 9f); lineTo(19.5f, 10.5f); lineTo(18f, 10.5f); close()

            moveTo(6f, 12f); lineTo(7.5f, 12f); lineTo(7.5f, 13.5f); lineTo(6f, 13.5f); close()
            moveTo(9f, 12f); lineTo(10.5f, 12f); lineTo(10.5f, 13.5f); lineTo(9f, 13.5f); close()
            moveTo(12f, 12f); lineTo(13.5f, 12f); lineTo(13.5f, 13.5f); lineTo(12f, 13.5f); close()
            moveTo(15f, 12f); lineTo(16.5f, 12f); lineTo(16.5f, 13.5f); lineTo(15f, 13.5f); close()
            moveTo(18f, 12f); lineTo(19.5f, 12f); lineTo(19.5f, 13.5f); lineTo(18f, 13.5f); close()

            moveTo(8f, 15f); lineTo(16f, 15f); lineTo(16f, 16.5f); lineTo(8f, 16.5f); close()
        }
    }.build()
}
