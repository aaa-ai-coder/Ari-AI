 ...
 * (Enter, Backspace). Also includes quick direct shortcuts for phone productivity.
 */
...
object TerminalKeyEncoder {
    ...
    fun encode(
        ...
        TerminalKey.Slash -> "/"
        TerminalKey.Dash -> "-"
        TerminalKey.Underscore -> "_"
        TerminalKey.Backtick -> "`"
        TerminalKey.Dollar -> "$"
        TerminalKey.Ampersand -> "&"
        TerminalKey.GreaterThan -> ">"
    }
