...
class FakeDataRepository : DataRepository {
    ...
    var storedVolumeKeysScrollTerminal: Boolean = true
    ...
    override fun getVolumeKeysScrollTerminal(): Boolean = storedVolumeKeysScrollTerminal

    override fun setVolumeKeysScrollTerminal(enabled: Boolean) {
        storedVolumeKeysScrollTerminal = enabled
    }
