...
class TerminalKeyEncoderTest {
    ...
    @Test
    fun directControlAndSymbolKeys() {
        assertEquals("\u0003", TerminalKeyEncoder.encode(TerminalKey.CtrlC))
        assertEquals("\u0004", TerminalKeyEncoder.encode(TerminalKey.CtrlD))
        assertEquals("\u000c", TerminalKeyEncoder.encode(TerminalKey.CtrlL))
        assertEquals("\u001a", TerminalKeyEncoder.encode(TerminalKey.CtrlZ))
        assertEquals("|", TerminalKeyEncoder.encode(TerminalKey.Pipe))
        assertEquals("~", TerminalKeyEncoder.encode(TerminalKey.Tilde))
        assertEquals("\\", TerminalKeyEncoder.encode(TerminalKey.Backslash))
        assertEquals("/", TerminalKeyEncoder.encode(TerminalKey.Slash))
        assertEquals("-", TerminalKeyEncoder.encode(TerminalKey.Dash))
        assertEquals("_", TerminalKeyEncoder.encode(TerminalKey.Underscore))
        assertEquals("`", TerminalKeyEncoder.encode(TerminalKey.Backtick))
        assertEquals("$", TerminalKeyEncoder.encode(TerminalKey.Dollar))
        assertEquals("&", TerminalKeyEncoder.encode(TerminalKey.Ampersand))
        assertEquals(">", TerminalKeyEncoder.encode(TerminalKey.GreaterThan))
    }
